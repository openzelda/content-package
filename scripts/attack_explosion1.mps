...
public Init(...)
{
	...
	qObject = ObjectCreate("explosion.png:1", SPRITE, qDisplayArea.x, qDisplayArea.y, qPosition.z, 0, 0);
...
CheckForCollisions()
{
	...
	while ( CollisionGetCurrent(_, current, angle, dist, rect )
	{
		...
		EntityCallFunction( current, "Hit", "sddddd", owner, angle, AEXPLOSION, DAMAGE, qPosition.y, qPosition.y, rect);
	}
}
